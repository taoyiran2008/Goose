...
public abstract class CarouselPagerAdapter<V extends CarouselViewPager> extends PagerAdapter {
    ...
    public CarouselPagerAdapter(Context context, V viewPager) {
        mContext = context;
    ...
    public final Object instantiateItem(ViewGroup container, int position) {
        int position2 = position % getRealDataCount();
        Object obj = instantiateRealItem(container, position2);
    ...
    public final void finishUpdate(ViewGroup container) {
        ...
        if (position == 0) {
            ...
            mViewPager.setCurrentItem(position, false); // 坑4，必须加false才能过渡平滑
