...
public final class ZhiboPresenter extends BasePresenter<ZhiboContract.View>
        implements ZhiboContract.Presenter {
     ...
     */
    @Inject
    public ZhiboPresenter() {
    }

    @Override
    public void getBannerList() {
        doRequest(mDataProvider.provideObservable(DataProvider.OperationType.GET_BANNER_LIST, DataProvider.DATA_TYPE_STREAM),
    ...
    public void getProductList(String category, int pageIndex, int pageSize) {
        doRequest(mDataProvider.provideObservable(DataProvider.OperationType.GET_PRODUCT_LIST,
                DataProvider.DATA_TYPE_STREAM, category, "", pageIndex, pageSize),
